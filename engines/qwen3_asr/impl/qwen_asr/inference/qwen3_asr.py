...
class Qwen3ASRModel:
    ...
    def __init__(
        ...
        # PATCH (TTS Audio Suite): optional progress streaming
        self._progress_bar = None
        self._streamer_factory = None
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        # PATCH (TTS Audio Suite): silence unused generation warnings
        try:
    ...
    def _infer_asr_transformers(
        ...
        for i in range(0, len(texts), batch_size):
            ...
            if self._streamer_factory is not None:
                try:
                    streamer = self._streamer_factory(self.max_new_tokens or 0, self._progress_bar)
                except Exception:
                    streamer = None
