...
class IndexTTS2:
    ...
    def infer_generator(self, spk_audio_prompt, text, output_path,
        ...
        # Check if speaker audio is provided
        if spk_audio_prompt is None:
            raise ValueError("Speaker audio prompt is required but was None. Please provide a valid speaker reference audio file.")
        ...
        # Warn if input text contains UNK tokens
