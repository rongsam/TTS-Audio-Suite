    ...
    def __init__(
        ...
        **kwargs,
        ...
        if code_predictor_config is None:
            ...
            logger.debug("code_predictor_config is None. Initializing code_predictor model with default values")
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if talker_config is None:
            talker_config = {}
            logger.debug("talker_config is None. Initializing talker model with default values")
        if speaker_encoder_config is None:
            speaker_encoder_config = {}
            logger.debug("speaker_encoder_config is None. Initializing talker model with default values")
